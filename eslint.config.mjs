...
const ANY_DEBT_BASELINE = [
  ...
  "src/components/automation/SimulationTool.tsx",
  ...
  "src/components/intelligence/hr/RoleDistributionChart.tsx",
  ...
  "src/components/rules/RuleMetadataForm.tsx",
  ...
  "src/components/salary/SalaryDetailModal.tsx",
  ...
  "src/lib/business-process/executor.ts",
  ...
  "src/lib/workflow-engine/steps/DecisionStep.ts",
  ...
  "src/modules/salary/actions/delete-adjustment.ts",
  "src/modules/salary/actions/reject-adjustment.ts",
  "src/modules/salary/actions/update-adjustment.ts",
  ...
  "src/services/discount-decision.service.ts",
  ...
  "src/services/intelligence/shared/helpers.ts",

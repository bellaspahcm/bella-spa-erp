-- ============================================================================
-- FIX EDUCATION SCHEMA - DROP AND RECREATE
-- 
-- Problem: courses table exists with wrong schema (missing course_code column)
-- Solution: Drop all 3 tables and recreate with correct schema
-- 

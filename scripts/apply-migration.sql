-- ============================================================================
-- Partner Portal Database Migration - QUICK APPLY
-- ============================================================================
-- 
-- INSTRUCTIONS:
...
--
-- WARNING: This will create 6 new tables with RLS policies
...
-- ✅ 6 update triggers created
-- ✅ 1 RPC function created
--
-- Next Steps:
-- 1. Run verification queries below
...
WHERE tablename LIKE 're_%'
  OR tablename = 'real_estate_projects'
  OR tablename = 'real_estate_products';
-- Expected: All true
...
GROUP BY tablename
ORDER BY tablename;
-- Expected: Multiple rows with counts

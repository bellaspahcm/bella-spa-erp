-- ============================================================
-- HOTFIX 2: Add product_sales_commission to calculate_ktv_salary_sheet
-- Bug: AI tính thiếu hoa hồng bán hàng (product_sales)
-- Fix: Join bảng product_sales và cộng vào total_salary
-- ============================================================
...
BEGIN
    ...
    -- ✅ NEW: Tính hoa hồng bán hàng từ product_sales
    ...
    calculated AS (
        SELECT
            ...
            -- ✅ FIXED: Was COALESCE(aw.work_days, 26.0)
            ...
            -- ✅ NEW: Live product sales commission
    ...
    resolved AS (
        SELECT
            ...
            END AS deductions,
            calculated.advances,
            -- ✅ NEW: Resolve product commission (saved vs live)
            CASE
    ...
    SELECT
        ...
        CASE
            ...
            ELSE GREATEST(
                ...
                + resolved.rating_bonus
                + resolved.kpi_bonus
                + resolved.product_sales_commission  -- ✅ NEW: bao gồm hoa hồng bán hàng
                - resolved.deductions
                - resolved.advances,
                0
            )::NUMERIC

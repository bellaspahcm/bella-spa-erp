...
-- Target Project: lvnvkpyxtuilhrabtlwv
...
BEGIN
    ...
    -- Accountant
    INSERT INTO users (email, full_name, role, status, tenant_id)
    VALUES ('ketoan@bellaspa.com.vn', 'Lê Thị Mai', 'accountant', 'active', tid)

-- ============================================================================
-- REAL ESTATE MODULE - PERFORMANCE OPTIMIZATION V2
-- ============================================================================
-- Version: 2.0.0
-- Date: 2026-08-02
-- Description: Comprehensive performance indexes applying Beauty Spa patterns
--              Based on: 20260622280000_performance_optimization_indexes.sql
-- Related: Phase 4c - Performance Optimization Best Practices (Playbook)
-- ============================================================================

-- ============================================================================
-- CRITICAL TENANT ISOLATION INDEXES
-- ============================================================================
-- Pattern from Playbook: ALWAYS filter tenant_id first, then status/date/FK
-- Purpose: Enable fast tenant-scoped queries (core requirement for multi-tenancy)
...
-- ============================================================================
-- Pattern: Optimize for FSM state transitions and agent assignment queries
...
-- ============================================================================
-- Pattern: Optimize for state machine queries and product availability checks
...
-- ============================================================================
-- Pattern: Optimize for contract lifecycle, installment tracking, revenue recognition
...
-- ============================================================================
-- Pattern: Optimize for accounting, cashflow, installment tracking
...
-- ============================================================================
-- Pattern: Optimize for agent performance, payroll, commission reports
...
-- ============================================================================
-- Pattern: Multi-column indexes for common report queries
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
  RAISE NOTICE '✅ REAL ESTATE PERFORMANCE OPTIMIZATION V2 DEPLOYED';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '📚 Based on Beauty Spa patterns:';
  RAISE NOTICE '  • 20260622280000_performance_optimization_indexes.sql';
  RAISE NOTICE '  • docs/guides/INDUSTRY_MODULE_DEVELOPMENT_PLAYBOOK.md';
  RAISE NOTICE '';
  RAISE NOTICE '⚠️  Production Deployment Notes:';
  RAISE NOTICE '  1. Run during low-traffic window (indexes build online)';
  RAISE NOTICE '  2. Monitor disk space (indexes ~15-20%% of table size)';
  RAISE NOTICE '  3. Verify query plans: EXPLAIN ANALYZE <query>';
  RAISE NOTICE '  4. Check index usage: pg_stat_user_indexes';
  RAISE NOTICE '';
END $$;

-- Migration: 20260526010000_ai_agent_salary_tools.sql
-- Description: Tạo hàm RPC calculate_ktv_salary_sheet hỗ trợ tính toán bảng lương KTV chi tiết thời gian thực cho CHRO Agent
...
-- Cấp quyền thực thi hàm RPC tính lương cho authenticate và service_role
GRANT EXECUTE ON FUNCTION public.calculate_ktv_salary_sheet(DATE) TO authenticated;
GRANT EXECUTE ON FUNCTION public.calculate_ktv_salary_sheet(DATE) TO service_role;

-- =========================================================================
-- Migration: F5.6 Cash Reconciliation Review Patch
-- Purpose: Patch CASH_GL_BALANCE review findings through additive CREATE OR REPLACE functions.
-- Scope: Cash only. Prepayment remains unchanged/pending separate semantic gate.
-- =========================================================================
...
COMMENT ON FUNCTION public.f5_run_reconciliation(UUID, TEXT, TEXT, UUID, TEXT, TIMESTAMPTZ) IS
    'F5.6 review patch: AP_GL_BALANCE + AR_GL_BALANCE + CASH_GL_BALANCE. '
    'Cash uses F2_BANK_ACCOUNT_GL_MAP:v1, F2_OPENING:v1, and F2_CASH:v1 contracts only. '
    'Prepayment remains gated pending semantic/account-mapping authority.';

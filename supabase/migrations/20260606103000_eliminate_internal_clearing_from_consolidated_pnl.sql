-- =============================================================================
-- Migration: Exclude inter-branch clearing from HQ consolidated P&L
-- Date: 2026-06-06
-- Purpose:
--   Inter-branch clearing creates branch-level revenue (511) and COGS (632)
--   entries so each branch can see its own settlement impact. At HQ level,
--   those entries are internal transfers and must be eliminated from the
--   consolidated P&L to avoid inflating network revenue and cost.
-- =============================================================================

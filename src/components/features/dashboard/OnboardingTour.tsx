              ...
              <div className="flex-1 flex flex-col md:flex-row gap-8 items-start mb-10">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <h2 className="text-3xl font-black text-foreground tracking-tight mt-1.5">
                      {STEPS[currentStep].title}
                    </h2>
                    <h4 className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mt-1">

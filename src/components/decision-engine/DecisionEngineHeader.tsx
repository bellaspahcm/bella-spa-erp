...
export default function DecisionEngineHeader() {
  ...
  return (
    <div className="bg-white/40 dark:bg-[#1c1b19]/40 backdrop-blur-md border-b border-slate-200/60 dark:border-slate-800/50 pt-8 px-6 md:px-8 pb-0">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                href={tab.href}
                className={`
                  flex items-center gap-2 py-3 px-1 border-b-2 font-semibold text-sm tracking-wide transition-all whitespace-nowrap

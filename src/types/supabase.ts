  ...
  public: {
    Tables: {
      ...
      hc_anesthesia_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_anesthesia_records_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: true
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
          },
          {
      ...
      hc_blood_crossmatch_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "hc_blood_crossmatch_records_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
      ...
      hc_clinical_calculations: {
        Row: {
          ...
          source_observation_references: Json | null
          tenant_id: string
        }
        Insert: {
          algorithm_category: string
        ...
        Relationships: [
          {
            foreignKeyName: "hc_clinical_calculations_encounter_id_fkey"
            columns: ["encounter_id"]
            isOneToOne: false
            referencedRelation: "hc_encounters"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hc_clinical_calculations_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "reconciliation_health_today"
            referencedColumns: ["tenant_id"]
      ...
      hc_clinical_orders: {
        Row: {
          ...
          order_type: string
          ordered_at: string
          ordering_practitioner_id: string | null
          priority: string | null
          status: string
          tenant_id: string
          updated_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "hc_clinical_orders_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hc_clinical_orders_ordering_practitioner_id_fkey"
            columns: ["ordering_practitioner_id"]
            isOneToOne: false
            referencedRelation: "mv_ktv_performance_summary"
            referencedColumns: ["ktv_id"]
          },
      ...
      hc_clinical_protocols: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_clinical_protocols_drug_code_fkey"
            columns: ["drug_code"]
            isOneToOne: false
            referencedRelation: "hc_drugs"
            referencedColumns: ["drug_code"]
          },
        ]
      }
      ...
      hc_drug_interactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_drug_interactions_drug_a_code_fkey"
            columns: ["drug_a_code"]
            isOneToOne: false
            referencedRelation: "hc_drugs"
            referencedColumns: ["drug_code"]
          ...
          {
            foreignKeyName: "hc_drug_interactions_drug_b_code_fkey"
            columns: ["drug_b_code"]
            isOneToOne: false
            referencedRelation: "hc_drugs"
            referencedColumns: ["drug_code"]
      ...
      hc_encounters: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_encounters_care_journey_id_fkey"
            columns: ["care_journey_id"]
            isOneToOne: false
            referencedRelation: "journey_journeys"
            referencedColumns: ["id"]
          },
      ...
      hc_imaging_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_imaging_orders_clinical_order_id_fkey"
      ...
      hc_implants: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "hc_implants_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: false
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
      ...
      hc_lab_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_lab_orders_clinical_order_id_fkey"
            columns: ["clinical_order_id"]
            isOneToOne: false
            referencedRelation: "hc_clinical_orders"
            referencedColumns: ["id"]
      ...
      hc_or_equipment_usage: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "hc_or_equipment_usage_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: false
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
      ...
      hc_order_cds_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_order_cds_overrides_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "hc_clinical_orders"
            referencedColumns: ["id"]
      ...
      hc_pacu_admissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_pacu_admissions_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: true
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
      ...
      hc_specimens: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_specimens_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: false
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
      ...
      hc_surgical_safety_checklists: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "hc_surgical_safety_checklists_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: true
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
      ...
      hc_surgical_teams: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_surgical_teams_surgical_case_id_fkey"
            columns: ["surgical_case_id"]
            isOneToOne: false
            referencedRelation: "hc_surgical_cases"
            referencedColumns: ["id"]
      ...
      hc_transfusion_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "hc_transfusion_records_crossmatch_id_fkey"
          ...
          {
            foreignKeyName: "hc_transfusion_records_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
            referencedRelation: "hc_blood_units"
            referencedColumns: ["id"]

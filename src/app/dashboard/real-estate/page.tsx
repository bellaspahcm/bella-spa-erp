...
export default function RealEstateDashboardPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm min-h-[180px] flex items-center">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          <img
            ...
            className="w-full h-full object-cover object-[center_top] opacity-100 dark:opacity-90"
          />
        </div>

        <div className="relative z-10 w-full px-6 py-7 flex flex-col lg:flex-row lg:items-center justify-between gap-6">

...
import { getTrainingClassAdminOverview } from '@/services/training-actions';
import { TrainingClassesClient } from './TrainingClassesClient';
    ...
    <div className="min-h-screen bg-background/30 p-6 lg:p-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="flex flex-col gap-4 border-b border-border pb-5 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-black text-slate-950">Lịch lớp đào tạo</h1>
                <p className="mt-1 text-sm font-semibold text-slate-500">
                  Tạo và quản lý lịch lý thuyết, thực hành, kiểm tra cho các khóa học.
                </p>
              </div>
            </div>
          </div>
        ...
        {!result.success ? (
          ...
          <TrainingClassesClient initialData={result.data} />
        )}
      </div>
    </div>
  );

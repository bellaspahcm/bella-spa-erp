...
export function buildSessionModalData(
  ...
  return {
    ...
    originalContractDetail: session.notes || 'Không có ghi chú',
    ...
    originalTime: session.assigned_time || '09:00 - 11:00',
    status: session.status || undefined,
    sessionNumber: session.session_number || 1,
    bookingResourceId: session.booking_resource_id || null,
    originalBookingResourceId: session.booking_resource_id || null,

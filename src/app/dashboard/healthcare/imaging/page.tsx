...
export default function ImagingPage() {
  ...
  return (
    <div className="p-6 md:p-8 w-full space-y-7 bg-transparent relative">
      ...
      {viewingDcmItem && (
        <div className="fixed inset-0 z-50 bg-[#070b14]/95 backdrop-blur-xl flex flex-col font-sans select-none text-white animate-in fade-in duration-200 overflow-x-hidden max-w-full">
          {/* Modal Header Bar - Responsive Wrap (No Slide Ngang) */}
          <div className="bg-[#0d1322] border-b border-slate-800 px-3 py-2 shrink-0 shadow-md max-w-full overflow-hidden">
            <div className="flex flex-wrap items-center justify-between gap-y-2 gap-x-3 w-full">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="px-2 py-0.5 rounded bg-indigo-600 text-white font-mono text-[10px] font-black tracking-wider shrink-0">
                ...
                <div className="min-w-0 truncate text-left">
                  <h2 className="text-xs font-black text-white flex items-center gap-1.5 truncate">
                    ...
                    <span className="text-slate-400 font-normal text-[10px]">({viewingDcmItem.ticketNumber})</span>
                  </h2>
              ...
              {/* Presets */}
              <div className="flex items-center gap-1 bg-[#12192c] p-0.5 rounded-lg border border-slate-800 text-[10px] font-bold shrink-0">
                {[
              ...
              <div className="flex items-center gap-2 text-xs shrink-0">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-2.5 py-1 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-[11px] font-bold flex items-center gap-1 shrink-0"
                >
                  Cửa Sổ Mới <ExternalLink className="w-3 h-3" />
                </a>
                <button
                  onClick={() => setViewingDcmItem(null)}
                  className="p-1.5 rounded-xl bg-slate-800 hover:bg-rose-600 text-slate-300 hover:text-white transition-all cursor-pointer shrink-0"

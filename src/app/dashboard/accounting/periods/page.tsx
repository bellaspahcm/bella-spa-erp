      ...
      <AnimatePresence>
        {activeModalPeriod && (
          ...
          >
            ...
            >
              {/* Modal header */}
              <div className="px-8 py-6 border-b border-slate-100 dark:border-[#3E3A35]/30 flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-black text-slate-900 dark:text-[#EFE9E1] flex items-center gap-2">
                    <Lock className="w-5 h-5 text-primary" />
                    Xem trước Bút toán Kết chuyển
                  </h3>
                  <p className="text-xs font-medium text-slate-500 dark:text-[#CDBCAB]/70 mt-1">
                ...
                {previewLoading ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {previewRows.map((row) => (
                      <div
                        key={row.step}
                        className="p-5 rounded-2xl bg-slate-50/40 dark:bg-[#11100F]/40 border border-slate-100 dark:border-[#3E3A35]/30 flex items-start gap-4"
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-3 pt-3 border-t border-slate-100 dark:border-[#3E3A35]/30">
                    ...
                    <div className={`p-5 rounded-2xl border-2 ${
                      ...
                      <span className={`font-mono font-black text-2xl ${isProfit ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
              ...
              {/* Modal footer */}
              <div className="px-8 py-5 border-t border-slate-100 dark:border-[#3E3A35]/30 flex items-center justify-end gap-3">
                <button
                  onClick={() => setActiveModalPeriod(null)}
                  disabled={closing}
                  className="px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest text-slate-600 dark:text-[#CDBCAB] hover:bg-slate-100 dark:hover:bg-[#11100F] cursor-pointer transition-colors disabled:opacity-50"
                >
                  Hủy
                </button>
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest text-white bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 cursor-pointer transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 active:scale-95"
                >
                  {closing ? (
                    <>

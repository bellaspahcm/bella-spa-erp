...
**Approach:** Bound API documentation checks to API/API-documentation changes, point API documentation scripts at the existing canonical docs, remove direct GitHub context interpolation from shell steps, and pin the exact mutable action tag reported by Semgrep OSS.

## Suggested Review Order

1. `../../.github/workflows/quality-security.yml` -- Review API docs gating and skipped-check behavior.

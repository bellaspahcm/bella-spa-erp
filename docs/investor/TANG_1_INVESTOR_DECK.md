...
## 🛝 SLIDE 18: Full Product Ecosystem Map
### Title: **Hệ sinh thái sản phẩm đầy đủ: 6 ngành, 5 sản phẩm, 45+ module**
#### Subtitle: *Một nền tảng lõi duy nhất phục vụ toàn bộ hệ sinh thái — không sao chép code.*

* **Bản đồ toàn hệ sinh thái (3 vòng):**
```
╔══════════════════════════════════════════════════════════════════╗
║  PRODUCT VERTICALS (đang vận hành / đang phát triển)            ║
║  Bella Spa · Bella Babycare · bella-hospital · bella-dental      ║
║  bella-medical · bella-land · bella-education · CleanPro         ║
╠══════════════════════════════════════════════════════════════════╣
║  INDUSTRY KERNELS (Domain Logic — Frozen & Tested)              ║
║  Healthcare(H1-H12) · Logistics(E7) · Finance · Education        ║
║  Real Estate · Accounting · Policy Engine · IAM Matrix           ║
╠══════════════════════════════════════════════════════════════════╣
║  PLATFORM CORE (Infrastructure — Read-Only Frozen)              ║
║  Identity · Event Bus · State Machine · BDGF · Architecture Guard║
║  Notification Hub · Scheduler · Search · Integration Hub · SDK   ║
╚══════════════════════════════════════════════════════════════════╝
```
...
## 🛝 SLIDE 19: Finance OS & HR/Payroll — Local Market Moat
### Title: **Finance OS + HR/Payroll: Rào chắn đặc biệt thị trường Việt Nam**
#### Subtitle: *Đối thủ toàn cầu không tối ưu cho TT133 — Bella được xây ngay từ đầu cho thị trường bản địa.*
...
* **HR & Payroll — Vòng đời nhân sự đầy đủ:**
  - **Commission Engine:** Tự động tính hoa hồng KTV dựa trên session_logs, session_multipliers (1.0x-2.0x), và chính sách phân cấp (Junior/Senior/Lead) — không cần Excel.
  - **Payroll TT133-compliant:** Phiếu lương đúng chuẩn, tích hợp BHXH, BHYT, thuế TNCN.
  - **Salary Reconciliation AI:** AI tự đối soát lịch chấm công vs. hoa hồng vs. kết quả thực tế, flag sai lệch cho quản lý duyệt.
  - **Approval Workflow:** Submit → Review → Approve → Paid với audit trail bất biến.

* **Switching Cost Strategy:**
  Khi doanh nghiệp đã dùng Payroll + Accounting của Bella (dữ liệu nhân sự, lịch sử lương, kế toán), chi phí chuyển đổi sang phần mềm khác là **cực kỳ cao** — tạo retention tự nhiên.

---

## 🛝 SLIDE 20: Marketplace & Mobile App — Platform Completeness
### Title: **Marketplace + Mobile App: Nền tảng hoàn chỉnh từ văn phòng đến hiện trường**
#### Subtitle: *App Store cho ngành dọc và ứng dụng di động cho nhân viên hiện trường.*

* **Bella Marketplace (App Store):**
  - **Third-party Module Store:** Các đối tác phát triển có thể đăng tải và bán module tích hợp (POS, camera, thiết bị y tế, payment gateway) trên Marketplace Bella.
  - **Revenue Model:** Bella thu **15-20% hoa hồng** từ mỗi giao dịch trên Marketplace — nguồn doanh thu passive scale theo số lượng Tenant.
  - **Tenant Self-Serve:** Tenant có thể cài module từ Marketplace mà không cần can thiệp code — đúng như mô hình App Store.
  - **Hiện trạng:** UI Marketplace đã có trong dashboard (`/dashboard/marketplace`), đang chuẩn bị onboard đối tác thứ 3 đầu tiên.

* **Mobile Application — Field-First Design:**
  - **Offline-Capable:** Nhân viên hiện trường (KTV, nhân viên vệ sinh công nghiệp, y tá tại nhà) có thể check-in/out, ghi nhận dịch vụ ngay cả khi mất mạng.
  - **GPS Verification:** Xác minh vị trí nhân viên tại điểm dịch vụ, chống chấm công gian lận.
  - **Session Management:** Bắt đầu/kết thúc ca, ghi chú dịch vụ, ảnh trước/sau, chữ ký khách hàng trực tiếp trên mobile.
  - **Multi-Module:** 1 app phục vụ cả KTV spa, nhân viên vệ sinh CleanPro, và y tá chăm sóc tại nhà — khác nhau chỉ ở module được kích hoạt.

* **CRM & Marketing Automation:**
  - **Customer Journey Tracking:** Theo dõi toàn bộ hành trình khách hàng từ lead → booking → session → loyalty.
  - **Campaign Engine:** Gửi SMS/email/push theo segment (khách sắp hết liệu trình, khách sinh nhật, khách VIP).
  - **AI Recommendations:** Đề xuất dịch vụ tiếp theo dựa trên lịch sử và hành vi khách hàng.
  - **Waitlist Management:** Tự động notify khách khi slot trống — giảm no-show, tăng revenue per slot.

---

## 🛝 SLIDE 21: Competitive Landscape
### Title: **Tại sao không phải Odoo, SAP, hay Salesforce?**
#### Subtitle: *Bella không cạnh tranh trực tiếp — Bella lấp đầy khoảng trống không ai phục vụ được.*

* **Ma trận so sánh:**

| Tiêu chí | Odoo | SAP B1 | Salesforce | **Bella AI** |
| :--- | :---: | :---: | :---: | :---: |
| **Hỗ trợ TT133 Việt Nam** | ❌ Tùy biến | ❌ Bản địa hóa kém | ❌ Không có | ✅ Native |
| **Ngành dọc chuyên biệt** | ❌ Generic | ❌ Generic | ❌ Generic | ✅ Per-industry Kernel |
| **Giá phù hợp SME** | ⚠️ Khó triển khai | ❌ Quá đắt ($50K+) | ❌ Quá đắt | ✅ SaaS từ 2M VND/tháng |
| **AI tích hợp vận hành** | ❌ Bolt-on | ❌ Bolt-on | ⚠️ Giới hạn | ✅ AI Workforce native |
...
* **Tại sao các ERP toàn cầu không thể copy:**
  ...
  2. Kiến trúc legacy của họ không thể modular hóa theo ngành dọc như Bella.
  3. AI Workforce của Bella tích hợp trực tiếp vào luồng vận hành — không phải chatbot gắn ngoài.
...
* **Slides ưu tiên khi có 30 phút:** 1 → 2 → 4 → 8 → 13 → 18 → 19 → 17 → 21
* **Slides kỹ thuật sâu (cho CTO/Tech Partner):** 4 → 5 → 10 → 11 → 13 → TANG_2 → TANG_3

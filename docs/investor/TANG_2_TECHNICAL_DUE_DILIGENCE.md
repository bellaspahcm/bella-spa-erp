...
* **5 lớp bảo vệ liên tục:**
  ...
  4. **Kiểm thử hồi quy liên tục (Regression Gate):** Chạy bắt buộc 52 bộ kiểm thử hồi quy y tế và 547 bộ kiểm thử logistics trước khi biên dịch gói sản phẩm.
...
### 5.1. Bảng chỉ số tái sử dụng của các Kernels

| Industry Kernel | Số lượng Động cơ (Engines) | Sản phẩm đang vận hành thực tế | Tỷ lệ Tái sử dụng (Ratio) | Trạng thái kỹ thuật |
| :--- | :---: | :--- | :---: | :--- |
| **Healthcare** | 27 engines | 3 (Hospital, Clinic, Dental) | **1:3** | ✅ Hoạt động ổn định, không trùng code |
| **Finance** | 2 engines | 2 (Spa Ledger, Education Billing) | **1:2** | 🟢 Được kích hoạt làm Infra dùng chung |
| **Accounting** | 1 service | 1 (bella-education accounting) | **1:1** | 🟢 Đang chạy thực tế |
| **Education** | 5 domains | 1 (bella-education) | **1:1** | 🟢 Đang chạy thực tế |
| **Real Estate** | 4 services | 1 (bella-land) | **1:1** | 🟢 Đang chạy thực tế |

* **Đặc điểm nổi bật:** 27 động cơ của Y tế (e.g. `bed-engine`, `clinical-decision-support`) phục vụ song song cho cả Bệnh viện lớn, Phòng khám đa khoa lẫn Phòng khám nha khoa mà **không bị sao chép hay phân nhánh mã nguồn (zero code duplication)**.
...
4. **Hệ thống Kiểm thử Hồi quy Quy mô lớn:** Hơn 330 bài test tự động bao phủ toàn bộ vòng đời ứng dụng, bảo vệ ranh giới kiến trúc và tính toàn vẹn tài chính trên mỗi lần deploy.
...
* **VALIDATED (Đã kiểm thử & xác thực kiến trúc):**
  ...
  - **Logistics OS Kernels (E7.1-E7.3):** 547 bài test hồi quy pass hoàn toàn.
